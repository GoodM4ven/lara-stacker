        ...
        <div class="flex items-center justify-center">
            <div class="flex flex-col justify-around">
                <div class="space-y-6 flex flex-col items-center">
                    <button
                        type="button"
                        class="w-fit flex ml-auto mr-auto transform focus:outline-none"
                    ...
                    <a
                        ...
                        target="_blank"
                        class="inline-flex w-min focus:outline-px focus:outline-gray-400 dark:focus:outline-dark-background-1 transition"
                    >
                        <h1
